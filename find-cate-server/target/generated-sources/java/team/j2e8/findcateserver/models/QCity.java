...
public class QCity extends EntityPathBase<City> {
    ...
    private static final long serialVersionUID = -1467219538L;

    public static final QCity city = new QCity("city");

    public final NumberPath<Integer> cityId = createNumber("cityId", Integer.class);

    public final StringPath cityPicture = createString("cityPicture");

    public final StringPath cityTitle = createString("cityTitle");
